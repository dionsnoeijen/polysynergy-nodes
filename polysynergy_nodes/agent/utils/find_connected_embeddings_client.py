...
def find_connected_embeddings_client(node_id: str, flow: Flow) -> ClientBase | None:
    ...
    for conn in client_connections:
        ...
        if hasattr(node, "provide_instance") and is_compatible_provider(node, EmbeddingsBase):
